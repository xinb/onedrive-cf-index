...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Yoo, I'm Xinb 👋</h2>
                    <p>This is Spencer's OneDrive public directory listing. Feel free to download any files that you find useful. Reach me at: ******** [at] gmail [dot] com.</p>
                    <p><a href="https://xinb.github.com">Portfolio</a> · <a href="https://xini.me">Blog</a> · <a href="https://github.com/xinb">GitHub</a></p>
                  </div>`
